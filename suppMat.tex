...
% add S in front of each reference
...
\TODO{i think should be in a separate word file (as for movies)}
\noindent
...
\TODO{reread/phrase whole text and change figures->illustrations etc.}
...
\addto\captionsenglish{\renewcommand{\refname}{\Title{Supplemental References}}}
\renewcommand{\refname}{\Title{Supplemental References}}
