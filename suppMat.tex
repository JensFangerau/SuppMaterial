...
{
{\bf All cell lineages located in the master cell file of the five wild type datasets and the \emph{aurora} mutant.} The left labels show the time points and an additional one at the top of each tree displays the total number of divisions. The colour of the nodes indicates the kind of division: \textcolor{red}{anticlinal}, \textcolor{green}{periclinal} and \textcolor{blue}{radial}.
}
...
{
{\bf All cell lineages of the five wild type datasets and the \emph{aurora} mutant.} The left labels show the time points and an additional one at the top of each tree displays the total number of divisions. The colour of the nodes indicates the kind of division: \textcolor{red}{anticlinal}, \textcolor{green}{periclinal} and \textcolor{blue}{radial}. The bricks visualisation at the bottom of each tree allows a comparison of division sequences among several trees.
}
	\label{fig:allTrees}
\end{sidewaysfigure}
\clearpage
...
{
{\bf Division sequence trees for all five wild type datasets and the \emph{aurora} mutant based on the number of cells.} \TODO{update tree of \emph{aurora}}The x-axis corresponds to the number of cells. The colours are uniquely assigned to each type of layering which is given by a sequence of the divisions. Links to movies depicting layer formations for each dataset are listed in Section~\ref{sec:suppmovies}.}
