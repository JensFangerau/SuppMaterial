...
\begin{picture}(0,0)\put(43,0){\rotatebox{0}{\parbox{\textwidth}{\section*{
Table S1: Related to Figure 1. \textbf{Metadata of light sheet recordings.}
}}}}\end{picture}
	\miniscule
...
& Light Intensity = 120-140 $\nicefrac{\mu \, \text{mol}}{m^2s}$ & Light Intensity = 120-140 $\nicefrac{\mu \, \text{mol}}{m^2s}$ & Light Intensity = 120-140 $\nicefrac{\mu \, \text{mol}}{m^2s}$ & Light Intensity = 120-140 $\nicefrac{\mu \, \text{mol}}{m^2s}$ & Light Intensity = 120-140 $\nicefrac{\mu \, \text{mol}}{m^2s}$ & Light Intensity = 120-140 $\nicefrac{\mu \, \text{mol}}{m^2s}$\\
...
\cmidrule{2-7}
& Data Acquisition & Data Acquisition & Data Acquisition & Data Acquisition & Data Acquisition & Data Acquisition\\
...
& Crop Dimension X $\times$ Y $\times$ Z & Crop Dimension X $\times$ Y $\times$ Z & Crop Dimension X $\times$ Y $\times$ Z & Crop Dimension X $\times$ Y $\times$ Z & Crop Dimension X $\times$ Y $\times$ Z & Crop Dimension X $\times$ Y $\times$ Z\\
& 555 $\times$ 221 $\times$ 147 & 689 $\times$ 393 $\times$ 200 & 736 $\times$ 376 $\times$ 170 & 682 $\times$ 406 $\times$ 130 & 666 $\times$ 404 $\times$ 130 & 684 $\times$ 378 $\times$ 110\\
\bottomrule
